...
//for changing color after some interval
...
void setup() {
  ...
  high.times_start = millis();Color.r = 1;Color.g = 0;Color.b = 0;
...
void loop() {
        //Serial.println(digitalRead(switchmode));
...
//for randomising and getting different colors
...
void changemaxvalue()
  {
    ...
    {
    maxRED=random(120,255);
    maxGREEN=random(80,255);
    maxBLUE=random(40,220);
    lasttime=millis();
    }
  }
